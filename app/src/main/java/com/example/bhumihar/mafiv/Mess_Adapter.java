 ...
 */
public class Mess_Adapter extends BaseAdapter{

    Context mcontext;
    ArrayList<Notification_Data> mess_value;
    TextView text1_v ,text2_v ,text3_v ,text4_v ,text_v5 ,text_v6 ,text_v7 ,text_v8;


    public Mess_Adapter(Context context) {
        mcontext = context;
        mess_value = new ArrayList<>();
    }

    @Override
    public int getCount() {
        return mess_value.size();
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Notification_Data notData = mess_value.get(i);
